...
<head>
    ...
    <title>Ordem de serviço <?php echo $this->renderSection('title'); ?> </title>
    ...
    <!-- render section CSS to views extends this layout -->
                ...
                <div class="right-menu list-inline no-margin-bottom">
                    ...
                    <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link messages-toggle"><i class="icon-email"></i><span class="badge dashbg-1">5</span></a>
                        <div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="#" class="dropdown-item message d-flex align-items-center">
                                <div class="profile"><img src="<?php echo base_url('assets'); ?>/img/avatar-3.jpg" alt="..." class="img-fluid">
                                ...
                                <div class="profile"><img src="<?php echo base_url('assets'); ?>/img/avatar-2.jpg" alt="..." class="img-fluid">
                                ...
                                <div class="profile"><img src="<?php echo base_url('assets'); ?>/img/avatar-1.jpg" alt="..." class="img-fluid">
                                ...
                                <div class="profile"><img src="<?php echo base_url('assets'); ?>/img/avatar-5.jpg" alt="..." class="img-fluid">
                    ...
                    <!-- Megamenu end     -->
                    <!-- Languages dropdown    -->
                    <div class="list-inline-item dropdown"><a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle"><img src="<?php echo base_url('assets'); ?>/img/flags/16/GB.png" alt="English"><span class="d-none d-sm-inline-block">English</span></a>
                        <div aria-labelledby="languages" class="dropdown-menu"><a rel="nofollow" href="#" class="dropdown-item"> <img src="<?php echo base_url('assets'); ?>/img/flags/16/DE.png" alt="English" class="mr-2"><span>German</span></a><a rel="nofollow" href="#" class="dropdown-item"> <img src="<?php echo base_url('assets'); ?>/img/flags/16/FR.png" alt="English" class="mr-2"><span>French </span></a></div>
                    </div>
                    <!-- Log out               -->
    ...
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header d-flex align-items-center">
                <div class="avatar"><img src="<?php echo base_url('assets'); ?>/img/avatar-6.jpg" alt="..." class="img-fluid rounded-circle"></div>
                <div class="title">
            ...
            <ul class="list-unstyled">
                <li class="<?php echo (url_is('/') ? 'active' : '') ?>"><a href="<?php echo base_url('/'); ?>"> <i class="icon-home"></i>Início </a></li>

                <li class="<?php echo (url_is('/users*') ? 'active' : '') ?>"><a href="<?php echo base_url('/users'); ?>"> <i class="icon-user"></i>Usuários </a></li>
